require 'rails_helper'
  ...
  feature 'User search a recipe' do
    scenario 'succefully' do
      ...
      expect(page).to have_css('h2', text: "Resultados da busca por: #{recipe.title}")
    ...
    scenario 'and leave the search field empty' do
      ...
      recipe = Recipe.create title: 'Bolo de Laranja', cuisine: cuisine, recipe_type: recipe_type,
                            difficulty: 'Fácil', cook_time: 50, ingredients: 'Farinha, laranja, ovo, leite, fermento',
                            cook_method: 'Bate tudo e coloca no forno'
      another_recipe = Recipe.create title: 'Bolo de Cenoura', cuisine: cuisine, recipe_type: recipe_type,
      difficulty: 'Fácil', cook_time: 45, ingredients: 'Farinha, cenoura, ovo, leite, fermento',
      cook_method: 'Bate tudo e coloca no forno'
