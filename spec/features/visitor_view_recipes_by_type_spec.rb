...
feature 'Visitor view recipes by type' do
  ...
  scenario 'and view only recipes from same type' do
    ...
    main_recipe = Recipe.create(title: 'Macarrão Carbonara',
                                ...
                                cook_method: 'Frite o bacon; Cozinhe a massa
                                              ate ficar al dent; Misture os
                                              ovos e o bacon a massa ainda
                                              quente;')
    visit root_path
  ...
  scenario 'and type has no recipe' do
    ...
    expect(page)
      .to have_content('Nenhuma receita encontrada para este tipo de receitas')
  end
end
